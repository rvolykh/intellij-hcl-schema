...
import (
	...
	"github.com/rvolykh/intellij-hcl-schema/proto/tfplugin5"
	"google.golang.org/grpc"
)

func getProviderSchemaV5(ctx context.Context, pluginPath string) (*model.ProviderSchema, error) {
	...
	grpcProviderClient := rawProviderClient.(tfplugin5.ProviderClient)

	request := new(tfplugin5.GetProviderSchema_Request)
...
type grpcPluginV5 struct {
	plugin.Plugin
}

func (p *grpcPluginV5) GRPCClient(ctx context.Context, broker *plugin.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
	return tfplugin5.NewProviderClient(c), nil
}
func (p *grpcPluginV5) GRPCServer(broker *plugin.GRPCBroker, s *grpc.Server) error {
	return nil
}

func parseV5(schema *tfplugin5.GetProviderSchema_Response) (*model.ProviderSchema, error) {
